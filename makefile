...
$Bbexkat1$O:	$Bbexkat1.c;	$(CC) $(CFLAGS) -c -Isrc -o $@ $Bbexkat1.c
...
$Bbexkat1.c:	$Blburg$E src/bexkat1.md;  $Blburg src/bexkat1.md    $@
...
clean::		testclean
		$(RM) $B*$O
		$(RM) $Bdagcheck.c $Balpha.c $Bbexkat1.c $Bmips.c $Bx86.c $Bsparc.c $Bx86linux.c
