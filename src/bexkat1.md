...
con16: CNSTI4 "%a" range(a, 0, 0xffff)
con16: CNSTU4 "%a" range(a, 0, 0xffff)
con16: CNSTI2 "%a" range(a, 0, 0xffff)
...
stmt: ASGNI1(addr,rc)  "ASGNI1(%0, %1)\n"  1
stmt: ASGNU1(addr,rc)  "ASGNU1(%0, %1)\n"  1
stmt: ASGNP4(addr,rc)  "ASGNP4(%0, %1)\n"  1
...
reg:  CVII4(INDIRI2(addr))     "CVII4(INDIRI2(addr)) %c,%0\n"  1
...
reg: LSHI4(reg,rc)  "sll %c,%0,%1\n"  1
reg: LSHU4(reg,rc)  "sll %c,%0,%1\n"  1
reg: RSHI4(reg,rc)  "sra %c,%0,%1\n"  1
reg: RSHU4(reg,rc)  "srl %c,%0,%1\n"  1
